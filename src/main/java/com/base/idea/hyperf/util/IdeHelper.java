...
import com.base.idea.hyperf.ui.HyperfProjectSettingsForm;
...
public class IdeHelper {
    ...
    private static final String NOTIFICATION_GROUP_ID = "hyperf base";
    ...
    public static void notifyEnableMessage(final Project project) {
        NotificationGroupManager.getInstance()
                ...
                .createNotification(
                        "hyperf base",
                        "Enable the hyperf base plugin <a href=\"enable\">with auto configuration now</a>, open <a href=\"config\">Project Settings</a> or <a href=\"dismiss\">dismiss</a> further messages",
                ...
                .setListener((notification1, event) -> {
                    if ("config".equals(event.getDescription())) {
                        ...
                        NotificationGroupManager.getInstance()
                                .getNotificationGroup(NOTIFICATION_GROUP_ID)
                                .createNotification("hyperf base", "Plugin enabled", NotificationType.INFORMATION)
                                .notify(project);
